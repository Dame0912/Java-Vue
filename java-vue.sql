...
insert  into `co_user`(`id`,`mobile`,`username`,`password`,`status`,`department_id`,`department_name`,`last_pwd_modified_time`,`avatar`,`creator`,`editor`,`created_time`,`modified_time`) values ('1249613010895708160','13600000001','管理员','123456',1,'1249309487725289472','行政部','2020-04-26 11:14:39','http://java-vue.oss-cn-hangzhou.aliyuncs.com/avatar/2020/05/04/8d78c3e3-f421-4521-ac6e-e1f8f30cfc65.png','管理员','管理员','2020-04-13 16:18:53','2020-05-04 16:25:48'),('1250737217079631872','13600000002','张三','a4e24a4d31f8c8aee8cf346945b0890c',1,'1249309851862179840','人事部',NULL,NULL,'管理员','管理员','2020-04-16 18:46:04','2020-04-26 11:12:40'),('1250737307668209664','13600000003','李四','a4e24a4d31f8c8aee8cf346945b0890c',1,'1249309945688760320','后勤部',NULL,NULL,'管理员','管理员','2020-04-16 18:46:26','2020-04-26 11:12:42'),('1250737486240702464','13600000004','王五','a4e24a4d31f8c8aee8cf346945b0890c',1,'1249309718567198720','财务部',NULL,NULL,'管理员','管理员','2020-04-16 18:47:08','2020-04-26 11:12:43'),('1250737604654292992','13600000005','赵六','a4e24a4d31f8c8aee8cf346945b0890c',1,'1249310042602348544','开发部',NULL,NULL,'管理员','管理员','2020-04-16 18:47:37','2020-04-26 11:12:46');

/*Table structure for table `excel_million_data` */

DROP TABLE IF EXISTS `excel_million_data`;

CREATE TABLE `excel_million_data` (
  `id` varchar(40) NOT NULL COMMENT 'ID',
  `breast` varchar(40) DEFAULT NULL,
  `adipocytes` varchar(20) DEFAULT NULL,
  `negative` varchar(255) DEFAULT NULL,
  `staining` varchar(255) DEFAULT NULL,
  `supportive` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='excel百万数据测试表';

/*Data for the table `excel_million_data` */
...
CREATE TABLE `excel_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='excel用户测试表';

/*Data for the table `excel_user` */

insert  into `excel_user`(`id`,`username`,`mobile`,`department_name`,`sex`,`native_place`,`date_of_birth`) values ('1257244234637934592','张三','13800001111','行政部','男','北京','2001-11-01'),('1257244234637934593','李四','13800001111','人事部','女','上海','2020-06-21'),('1257244234637934594','王五','13800001111','开发部','男','广州','2019-11-02'),('1257244234637934595','赵六','13800001111','测试部','男','深圳','2001-12-05'),('1257244234637934596','田七','13800001111','运维部','男','天津','2001-11-23'),('1257244234637934597','徐八','13800001111','财务部','男','深圳','2001-11-03'),('1257244234637934598','老九','13800001111','后勤部','男','黑龙江','2011-11-04'),('1257244234637934599','双录','13800001111','产品部','男','山西','2011-03-15'),('1257244234637934600','回调','13800001111','销售部','男','安徽','2021-11-06'),('1257244234637934601','科技示范','13800001111','人事部','男','河北','2009-06-07'),('1257244234637934602','开始拦截','13800001111','开发部','女','新疆','2001-11-08'),('1257244234637934603','了解了','13800001111','运维部','男','大连','2011-11-09'),('1257244234637934604','啊垃圾','13800001111','产品部','男','重庆','2009-09-10'),('1257244234637934605','可乐似','13800001111','销售部','女','四川','2001-11-11'),('1257244234637934606','离开家','13800001111','售后部','男','北京','2015-11-12'),('1257244234637934607','路径','13800001111','行政部','男','杭州','2009-07-23'),('1257244234637934608','老家啊','13800001111','测试部','女','江苏','2008-12-14'),('1257244234637934609','拉链款','13800001111','开发部','男','天津','2011-01-25'),('1257245051956789248','张三','13800001111','行政部','男','北京','2001-11-01'),('1257245051956789249','李四','13800001111','人事部','女','上海','2020-06-21'),('1257245051956789250','王五','13800001111','开发部','男','广州','2019-11-02'),('1257245051956789251','赵六','13800001111','测试部','男','深圳','2001-12-05'),('1257245051956789252','田七','13800001111','运维部','男','天津','2001-11-23'),('1257245051956789253','徐八','13800001111','财务部','男','深圳','2001-11-03'),('1257245051956789254','老九','13800001111','后勤部','男','黑龙江','2011-11-04'),('1257245051956789255','双录','13800001111','产品部','男','山西','2011-03-15'),('1257245051956789256','回调','13800001111','销售部','男','安徽','2021-11-06'),('1257245051956789257','科技示范','13800001111','人事部','男','河北','2009-06-07'),('1257245051956789258','开始拦截','13800001111','开发部','女','新疆','2001-11-08'),('1257245051956789259','了解了','13800001111','运维部','男','大连','2011-11-09'),('1257245051956789260','啊垃圾','13800001111','产品部','男','重庆','2009-09-10'),('1257245051956789261','可乐似','13800001111','销售部','女','四川','2001-11-11'),('1257245051956789262','离开家','13800001111','售后部','男','北京','2015-11-12'),('1257245051956789263','路径','13800001111','行政部','男','杭州','2009-07-23'),('1257245051956789264','老家啊','13800001111','测试部','女','江苏','2008-12-14'),('1257245051956789265','拉链款','13800001111','开发部','男','天津','2011-01-25'),('1257245123381592064','张三','13800001111','行政部','男','北京','2001-11-01'),('1257245123381592065','李四','13800001111','人事部','女','上海','2020-06-21'),('1257245123381592066','王五','13800001111','开发部','男','广州','2019-11-02'),('1257245123381592067','赵六','13800001111','测试部','男','深圳','2001-12-05'),('1257245123381592068','田七','13800001111','运维部','男','天津','2001-11-23'),('1257245123381592069','徐八','13800001111','财务部','男','深圳','2001-11-03'),('1257245123381592070','老九','13800001111','后勤部','男','黑龙江','2011-11-04'),('1257245123381592071','双录','13800001111','产品部','男','山西','2011-03-15'),('1257245123381592072','回调','13800001111','销售部','男','安徽','2021-11-06'),('1257245123381592073','科技示范','13800001111','人事部','男','河北','2009-06-07'),('1257245123381592074','开始拦截','13800001111','开发部','女','新疆','2001-11-08'),('1257245123381592075','了解了','13800001111','运维部','男','大连','2011-11-09'),('1257245123381592076','啊垃圾','13800001111','产品部','男','重庆','2009-09-10'),('1257245123381592077','可乐似','13800001111','销售部','女','四川','2001-11-11'),('1257245123381592078','离开家','13800001111','售后部','男','北京','2015-11-12'),('1257245123381592079','路径','13800001111','行政部','男','杭州','2009-07-23'),('1257245123381592080','老家啊','13800001111','测试部','女','江苏','2008-12-14'),('1257245123381592081','拉链款','13800001111','开发部','男','天津','2011-01-25'),('1257245546783997952','张三','13800001111','行政部','男','北京','2001-11-01'),('1257245546783997953','李四','13800001111','人事部','女','上海','2020-06-21'),('1257245546783997954','王五','13800001111','开发部','男','广州','2019-11-02'),('1257245546783997955','赵六','13800001111','测试部','男','深圳','2001-12-05'),('1257245546783997956','田七','13800001111','运维部','男','天津','2001-11-23'),('1257245546783997957','徐八','13800001111','财务部','男','深圳','2001-11-03'),('1257245546783997958','老九','13800001111','后勤部','男','黑龙江','2011-11-04'),('1257245546783997959','双录','13800001111','产品部','男','山西','2011-03-15'),('1257245546783997960','回调','13800001111','销售部','男','安徽','2021-11-06'),('1257245546783997961','科技示范','13800001111','人事部','男','河北','2009-06-07'),('1257245546783997962','开始拦截','13800001111','开发部','女','新疆','2001-11-08'),('1257245546783997963','了解了','13800001111','运维部','男','大连','2011-11-09'),('1257245546783997964','啊垃圾','13800001111','产品部','男','重庆','2009-09-10'),('1257245546783997965','可乐似','13800001111','销售部','女','四川','2001-11-11'),('1257245546783997966','离开家','13800001111','售后部','男','北京','2015-11-12'),('1257245546783997967','路径','13800001111','行政部','男','杭州','2009-07-23'),('1257245546783997968','老家啊','13800001111','测试部','女','江苏','2008-12-14'),('1257245546783997969','拉链款','13800001111','开发部','男','天津','2011-01-25');
