    ...
    <div class="login-container">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
        ...
        <span class="svg-container">
          ...
          <el-input ref="username" v-model="loginForm.username" placeholder="用户名" name="username" type="text" autocomplete="on"/>
        </el-form-item>
        ...
        <div style="position:relative; margin-top: 20px">
          <div class="tips">
            <span><i>普通用户在用户管理菜单，展示的按钮不同</i></span><br>

            <br>
            <div style="width: 90px; display: inline-block">超级管理员：</div>
            <span style="margin-right:18px;">用户名 : 13600000001</span>
            <span>密码 : 123456</span>
            <br>

            <div style="width: 90px; display: inline-block">普通用户：</div>
            <span style="margin-right:18px;">用户名 : 13600000002</span>
            <span>密码 : 123456</span>
            <br>

            <div style="width: 90px; display: inline-block">普通用户：</div>
            <span style="margin-right:18px;">用户名 : 13600000003</span>
            <span>密码 : 123456</span>
            <br>

            <div style="width: 90px; display: inline-block">普通用户：</div>
            <span style="margin-right:18px;">用户名 : 13600000004</span>
            <span>密码 : 123456</span>
            <br>

            <div style="width: 90px; display: inline-block">游客：</div>
            <span style="margin-right:18px;">用户名 : 13600000005</span>
            <span>密码 : 123456</span>
          </div>
        </div>
      </el-form>
